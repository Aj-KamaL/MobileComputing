...
public class CleanComplaint {
    ...
    public CleanComplaint(String complaintNum, String complaintType, String complaintFrom, String complaintTo, String complaintRoom,String priority, String complaintDescription, String completed, String locationBuilding) {
