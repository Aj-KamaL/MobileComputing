...
public class ObjComplaintStatusStudentAdapter extends RecyclerView.Adapter<ObjComplaintStatusStudentAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        Log.e("AJ", (product.getPriority().equals("-1"))+" "+ product.getPriority());
        if(product.getPriority().equals("-1")) {
        ...
        if (product.to.length()==0||product.to.equals("NULL")||product.to.equals("Not Yet Assigned")){
            holder.location.setText("Not Yet Assigned");
        }
        else{
            holder.location.setText(product.to);
        }
...
//        holder.imageView.setImageDrawable(mCtx.getResources().getDrawable(product.getImage()));
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textViewTitle, textViewShortDesc, textViewRating, textViewPrice, location;
//        ImageView imageView;

        public ProductViewHolder(View itemView) {
            super(itemView);

            location = itemView.findViewById(R.id.worker);
